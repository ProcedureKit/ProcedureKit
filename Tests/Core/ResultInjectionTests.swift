...
class DataProcessing: Operations.Operation, AutomaticInjectionOperationType {
...
class ManualResultInjectionTests: ResultInjectionTests {
    ...
    func test__block_is_executed() {
        ...
        addCompletionBlockToTestOperation(processing, withExpectation: expectation(withDescription: "Test: \(#function)"))
