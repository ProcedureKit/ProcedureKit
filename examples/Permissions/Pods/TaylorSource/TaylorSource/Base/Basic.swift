...
public final class StaticDatasource<
    ...
    - parameter items: an array of Factory.ItemType instances.
    */
    ...
    */
    ...
    - parameter indexPath: an NSIndexPath
    - returns: a dequeued and configured Factory.CellType
    */
    ...
    - returns: a dequeued and configured Factory.SupplementaryViewType
    */
