...
internal class ExclusivityManager {
    ...
    func addOperation(_ operation: Operation, category: String) -> Foundation.Operation? {
        return queue.sync { self._addOperation(operation, category: category) }
    }
    ...
    private func _addOperation(_ operation: Operation, category: String) -> Foundation.Operation? {
